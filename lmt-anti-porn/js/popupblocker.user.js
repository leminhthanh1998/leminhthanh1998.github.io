...
var examineTarget = elementsFromPoint ? function (currentEvent, popupHref, popupContext) {
    ...
    subroutine_checkMaskData: {
        ...
        for (var i = 0, l = potentialMaskData.length; i < l; i++) {
            var maskData = potentialMaskData[i];
